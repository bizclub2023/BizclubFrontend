...
console.log("entro aqui")
  ...
  if(user.get("email").toLowerCase()==="golfredo.pf@gmail.com"||user.get("email").toLowerCase().toLowerCase()==="karlaisaparedes11@gmail.com"||user.get("email").toLowerCase()==="ricardouzalt1207@gmail.com"){
    await setAdmin(true)
    await setIsCostumer(false)
